...
class Student:
    def __init__(self,root):
        ...
        Manage_Frame.place(x=0,y=85,width=450,height=710)
        ...
        lbl_Attendance=Label(Manage_Frame,text="Attendance",bg="crimson",fg="white",font=("times new roman",20,"bold"))
        lbl_Attendance.grid(row=8,column=0,pady=5,padx=20,sticky="w")    
        
        txt_Attendance=Entry(Manage_Frame,textvariable=self.Attendance_var,font=("times new roman",15,"bold"),bd=5,relief=GROOVE)
        txt_Attendance.grid(row=8,column=1,pady=5,padx=20,sticky="w") 
        
        lbl_CGPA=Label(Manage_Frame,text="CGPA",bg="crimson",fg="white",font=("times new roman",20,"bold"))
        lbl_CGPA.grid(row=9,column=0,pady=5,padx=20,sticky="w")    
        
        txt_CGPA=Entry(Manage_Frame,textvariable=self.CGPA_var,font=("times new roman",15,"bold"),bd=5,relief=GROOVE)
        txt_CGPA.grid(row=9,column=1,pady=5,padx=20,sticky="w")
     
        #button
        btn_Frame=Frame(Manage_Frame,bd=4,relief=RIDGE,bg="crimson")
        btn_Frame.place(x=10,y=650,width=420)
        ...
        Detail_Frame.place(x=450,y=85,width=1075,height=710)
        ...
        Table_Frame.place(x=10,y=70,width=1050,height=620)
        
        scroll_x=Scrollbar(Table_Frame,orient=HORIZONTAL)
        scroll_y=Scrollbar(Table_Frame,orient=VERTICAL)
        self.Student_table=ttk.Treeview(Table_Frame,columns=("roll","name","email","gender","contact","dob","Address","CGPA","Attendance"),xscrollcommand=scroll_x.set,yscrollcommand=scroll_y.set)
    ...
    def get_cursor(self,ev):
        ...
        self.Attendance_var.set(row[7])
        self.CGPA_var.set(row[8])
        self.txt_Address.delete("1.0",END)
    ...
    def update_data(self):
        con=pymysql.connect(host="localhost",user="root",password="",database="stm")
        cur=con.cursor()
        cur.execute("update students set name=%s,email=%s,gender=%s,contact=%s,dob=%s,address=%s,Attendance=%s,CGPA=%s where roll_no=%s",(
                                                                                                self.name_var.get(),
                                                                                                self.email_var.get(),
                                                                                                self.gender_var.get(),
                                                                                                self.contact_var.get(),
